...
//       <Header />
//       <div
//         className="w-100 home-slider2 slide current slider-content"
//         style={{
//           height: "510px",
//           display: "flex",
//           alignItems: "center",
...
//           position: "relative",
//           backgroundImage: `url(
//             "https://www.adityaimpex.biz/static/media/slide15.ba144a11.jpg"
//           )`,
...
//               <div className="row portfolio-grid align-items-center">
...
import AgriPortfolio from "../element/agriPortfolio";
import AgriSlider from "../element/agriSlider";
import { agriSliderContent } from "../element/SliderContent";
...
class AgriculturePortfolio extends Component {
  state = {
    isOpen: false,
  };
  ...
  render() {
    return (
      <>
        <Header />
        <AgriSlider
          data={agriSliderContent}
          contentWrapperCls="sliderStyle3"
          hideBtn
        />

        <AgriPortfolio col="col-12 col-sm-6 col-lg-3 d-flex justify-content-center" />
...
export default AgriculturePortfolio;
