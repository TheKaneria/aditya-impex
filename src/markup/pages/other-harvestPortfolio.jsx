...
const images = [
  {
    ...
    name: "system",
    system: true,
    route: "/seed-cleaning-machine-details",
    title: "Seed Cleaning Machine",
    // subTitle:"System",
    imgUrl: require("../../images/Harvesting/SEED CLEANING MACHINE.jpg"),
  },

  {
    ...
    name: "system",
    system: true,
    route: "/drum-cleaner-details",
    title: "Drum Cleaner",
    // subTitle:"System",
    imgUrl: require("../../images/Harvesting/drum-cleaner-vibratory-separator-500x500.jpg"),
  },

  {
    ...
    name: "system",
    system: true,
    route: "/wheat-cleaning-machine",
    title: "Wheat Cleaning Machine",
    // subTitle:"System",
    imgUrl: require("../../images/Harvesting/02 GRAIN CLEANING MACHINE 1.jpg"),
  },
  ...
  //   name: "system",
  //   system: true,
  //   route:"/other-harvest-seed-drill-details",
  //   title:" Seed Drill",
  //   subTitle:"System",
...
const OtherHarvestPortfolio = (props) => {
...
export default OtherHarvestPortfolio;
