...
class ListerEngineSpareDetails extends Component {
  state = {
    isOpen: false,
  };
            ...
            <div class="container">
              <div class="dlab-bnr-inr-entry">
                <h1 class="text-white font-weight-200 m-b10 ">
                  Lister Type Engine Spares Details{" "}
                </h1>
                <div class="breadcrumb-row">
                  <ul class="list-inline">
                    ...
                    <li>Lister Type Engine Spares Details</li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div class="container">
                <div class="row p-2">
                  <div class="col-lg-6 m-b30">
                    ...
                    <h6>
                      We can supply wide range of Lister spares and we carry a
...
export default ListerEngineSpareDetails;
